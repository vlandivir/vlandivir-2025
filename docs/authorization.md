...
| API дневника | `GET /diary-api/calendar`, `GET /diary-api/day`, `PATCH /diary-api/notes/:id`, `PATCH /diary-api/images/:id`, `POST /diary-api/images/:id/describe` | `src/diary-api.controller.ts` (guard на классе) |
