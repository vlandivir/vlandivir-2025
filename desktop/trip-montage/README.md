...
Локальный монтаж trip-альбомов для CapCut: Google auth как на сайте, ленивый кэш видео (скачать / удалить один файл / очистить весь кэш), trim и export папки `01-….mp4` через системный `ffmpeg`.
